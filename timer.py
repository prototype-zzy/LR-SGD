...
class Timer:
    ...
    def __init__(self, rank, verbosity_level=2, skip_first=True):
        self.verbosity_level = verbosity_level
        self.log_fn = self.metric
    ...
    def summary(self):
        ...
        with StringIO() as buffer:
            ...
            print("-----------------------------------------------------------------", file=buffer)
            print("- total time", total_runtime)
    ...
    def test_accuracy(self, epoch, model, test_set, device, log):
        correct = 0
        total = 0
        with torch.no_grad():
            ...
            print(epoch, 100 * correct / total, file=log)
